...
# 训练函数
def train_ch13(net, train_iter, test_iter, loss,lossd, optimizer, start_epoch,num_epochs, scheduler,swa_start, devices=d2l.try_all_gpus(), weight_path = None, data_dir = None):
...
#model =torch.load("/home3/qinyiming/organoid/our_FFT/log/checkpoints/net_121.pth", map_location='cpu').to('cuda:0')
...
#lossf = nn.BCELoss()
train_ch13(model, train_loader, val_loader, lossf, lossd,optimizer, start_epoch,epochs_num, scheduler=schedule, swa_start=swa_start, weight_path="./log/checkpoints", data_dir="./log/log")